...
namespace dbfirstTest.Persistance.Context
{
    public partial class opcContext : DbContext
    {
        ...
        //    {
        //        optionsBuilder.UseSqlServer("Data Source=SQLSRV\\DB2;Initial Catalog=opc;Persist Security Info=True;User ID=opc_client;Password=abc123*");
        //    }
        //}
